...
import { RokType } from '../interface/type';

const initialState: RokType = {
  error: '',
  isLoading: false,
};

export const PlayerContext = createContext<RokType>(initialState);
export const PlayerState: React.FC = ({ children }) => {
  ...
  //   dispatch({ type: IS_LOADING, payload: true });
  //   try {
  //     const res = await axiosWithAuth().post(`/alliance/applications/apply/${allianceId}`);
  ...
  //   dispatch({ type: IS_LOADING, payload: true });
  //   try {
  //     const res = await axiosWithAuth().delete(`/alliance/applications/cancel/${allianceId}`);
  //     console.log('res', res);
  ...
  //   dispatch({ type: IS_LOADING, payload: true });
  //   try {
  //     const res = await axiosWithAuth().post(`/event/participation/${eventId}`, { data });
  ...
  //   dispatch({ type: IS_LOADING, payload: true });
  //   try {
  //     const res = await axiosWithAuth().put(`alliance/${profileId}/accept/${allianceId}`);
